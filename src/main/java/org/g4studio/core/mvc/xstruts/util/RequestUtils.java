...
public class RequestUtils {
	...
	/*
    2014/04/27 - CVE-2014-0114 security problem patch.
	 */

	public static final String regex ="(.*\\.|^|.*|\\[('|\"))class(\\.|('|\")]|\\[).*";
	...
	public static void populate(Object bean, String prefix, String suffix, HttpServletRequest request)
		...
		while (names.hasMoreElements()) {
			...
			/** Struts1 ClassLoader 漏洞解决方案 **/
			if (stripped.matches(regex)) {
		          log.info("ignoreparameter: paramName=" + stripped);
		          continue;
			} 
