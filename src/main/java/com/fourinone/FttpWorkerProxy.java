...
public class FttpWorkerProxy extends WorkerServiceProxy
{
	...
	@Delegate(interfaceName="com.fourinone.FttpLocal",methodName="gZip",policy=DelegatePolicy.Implements)
	public boolean gZipFile(String f) throws Throwable{
		try{
			return fw.gZipFile(f);
		}catch(Throwable e){
			LogUtil.info("gZipFile", "exception", e);
			throw e;
		}
	}
}