...
public class XmlUtil
{
	...
	public ArrayList getXmlPropsByFile(String filePath, String PROPSROW_DESC, String KEY_DESC)
	{
		...
		*/
		...
		try
		{
			...
			//filePath = fullUsrDirPath(filePath);
	...
	*/
	...
	{
		String localPath = XmlUtil.class.getResource("").getPath(); 
		try {
...
//		System.out.println(localPath);
	 ...
	 * @return 文件全路径
	 */
	public static String fullUsrDirPath(String fileame)
	{
		return getLocalPath() + fileame;
	}
